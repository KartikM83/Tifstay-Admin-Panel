...
// function Providers({ users, setUsers }) {
...
//           Users Management / Tiffin or Restaurant...
//         </h2>
...
//                 <th className="px-4 py-2">Tiffin/Restaurant Provider Name</th>
...
//                        onClick={()=>
//                         navigate(`/tiffin/edit/${user.id}`, {state: {user}})
//                        }>
